        ...
        <div class="card">
          <div class="card-body">
            <p> <strong><?= $userid2 ?> <?= $usernama2 ?> :</strong> <i>
                <form action="komentar.php" method="post" class="form-control">
                  <input type="text" name="fotoid" value="<?= $fotoid2 ?>" hidden>
                  <input type="text" name="isikomentar" id="isikomentar" class="form-control">
                  <input type="submit" value="komentar" name="komentar" class="btn btn-info" hidden>
                </form>
              </i> </p>
          </div>
        </div>
